...
const Velaris = ({
  ...
  useEffect(() => {
    ...
    // Reduced internal resolution — this is a soft/blurred gradient, so the
    // upscaling is invisible, and it keeps GPU cost low when several
    // instances of Velaris run on the same page.
    ...
    const render = (t: number) => {
      if (!hidden && onScreen) {
        ...
        gl.uniform1f(locs.time, prefersReducedMotion ? 0 : t * 0.001 * speed);
